...
#include "mex.h"
#include "../include/doublependulum_QP_solver.h"

/* copy functions */
void copyCArrayToM(doublependulum_QP_solver_FLOAT *src, double *dest, int dim) {
    while (dim--) {
        *dest++ = (double)*src++;
    }
}
void copyMArrayToC(double *src, doublependulum_QP_solver_FLOAT *dest, int dim) {
    while (dim--) {
        *dest++ = (doublependulum_QP_solver_FLOAT)*src++;
    }
}
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] )  
{
	...
	const char *infofields[15] = { "it",
							   ...
							   "step_cc",
							   "solvetime"};
	doublependulum_QP_solver_params params;
	doublependulum_QP_solver_output output;
	doublependulum_QP_solver_info info;
	
	/* Check for proper number of arguments */
    if (nrhs != 1) {
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help doublependulum_QP_solver_mex' for details.");
    }    
	if (nlhs > 3) {
    ...
    mexErrMsgTxt("PARAMS.f1 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f1, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb1 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb1, 19);
    ...
    mexErrMsgTxt("PARAMS.ub1 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub1, 11);
    ...
    if( mxGetM(par) != 9 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C1 must be of size [9 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C1, 171);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f2 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f2, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb2 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb2, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub2 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub2, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C2 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C2, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f3 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f3, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb3 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb3, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub3 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub3, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C3 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C3, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f4 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f4, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb4 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb4, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub4 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub4, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C4 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C4, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f5 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f5, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb5 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb5, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub5 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub5, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C5 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C5, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f6 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f6, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb6 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb6, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub6 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub6, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C6 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C6, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f7 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f7, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb7 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb7, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub7 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub7, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C7 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C7, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f8 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f8, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb8 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb8, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub8 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub8, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C8 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C8, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f9 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f9, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb9 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb9, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub9 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub9, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C9 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C9, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f10 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f10, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb10 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb10, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub10 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub10, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C10 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C10, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f11 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f11, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb11 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb11, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub11 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub11, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C11 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C11, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f12 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f12, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb12 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb12, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub12 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub12, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C12 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C12, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f13 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f13, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb13 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb13, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub13 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub13, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C13 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C13, 95);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f14 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f14, 19);
    ...
    if( mxGetM(par) != 19 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb14 must be of size [19 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb14, 19);
    ...
    if( mxGetM(par) != 11 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub14 must be of size [11 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub14, 11);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 19 ) {
    mexErrMsgTxt("PARAMS.C14 must be of size [5 x 19]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C14, 95);
	...
	/* call solver */
	exitflag = doublependulum_QP_solver_solve(&params, &output, &info);
	
	/* copy output to matlab arrays */
	plhs[0] = mxCreateStructMatrix(1, 1, 15, outputnames);
	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z1, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z1", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z2, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z2", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z3, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z3", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z4, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z4", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z5, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z5", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z6, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z6", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z7, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z7", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z8, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z8", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z9, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z9", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z10, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z10", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z11, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z11", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z12, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z12", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z13, mxGetPr(outvar), 11);
	mxSetField(plhs[0], 0, "z13", outvar);

	outvar = mxCreateDoubleMatrix(11, 1, mxREAL);
	copyCArrayToM( output.z14, mxGetPr(outvar), 11);
