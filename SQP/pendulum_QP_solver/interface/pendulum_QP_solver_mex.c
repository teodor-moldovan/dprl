...
/* copy functions */
void copyCArrayToM(pendulum_QP_solver_FLOAT *src, double *dest, int dim) {
    while (dim--) {
        *dest++ = (double)*src++;
    }
}
void copyMArrayToC(double *src, pendulum_QP_solver_FLOAT *dest, int dim) {
    while (dim--) {
        *dest++ = (pendulum_QP_solver_FLOAT)*src++;
    }
}
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] )  
{
    ...
    mexErrMsgTxt("PARAMS.f1 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f1, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb1 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb1, 10);
    ...
    if( mxGetM(par) != 5 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C1 must be of size [5 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C1, 50);
    ...
    mexErrMsgTxt("PARAMS.e1 must be of size [5 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e1, 5);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f2 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f2, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb2 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb2, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C2 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C2, 30);
    ...
    mexErrMsgTxt("PARAMS.e2 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e2, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f3 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f3, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb3 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb3, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C3 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C3, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e3 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e3, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f4 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f4, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb4 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb4, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C4 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C4, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e4 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e4, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f5 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f5, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb5 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb5, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C5 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C5, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e5 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e5, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f6 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f6, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb6 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb6, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C6 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C6, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e6 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e6, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f7 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f7, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb7 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb7, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C7 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C7, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e7 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e7, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f8 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f8, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb8 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb8, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C8 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C8, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e8 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e8, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f9 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f9, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb9 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb9, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C9 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C9, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e9 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e9, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f10 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f10, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb10 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb10, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C10 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C10, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e10 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e10, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f11 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f11, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb11 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb11, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C11 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C11, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e11 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e11, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f12 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f12, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb12 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb12, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C12 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C12, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e12 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e12, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f13 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f13, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb13 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb13, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C13 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C13, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e13 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e13, 3);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.f14 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.f14, 10);
    ...
    if( mxGetM(par) != 10 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb14 must be of size [10 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb14, 10);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 10 ) {
    mexErrMsgTxt("PARAMS.C14 must be of size [3 x 10]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.C14, 30);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.e14 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.e14, 3);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.lb15 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.lb15, 3);
    ...
    if( mxGetM(par) != 3 || mxGetN(par) != 1 ) {
    mexErrMsgTxt("PARAMS.ub15 must be of size [3 x 1]");
    }
#endif	 
    copyMArrayToC(mxGetPr(par), params.ub15, 3);

	/* call solver */
	exitflag = pendulum_QP_solver_solve(&params, &output, &info);
	...
	copyCArrayToM( output.z15, mxGetPr(outvar), 3);
