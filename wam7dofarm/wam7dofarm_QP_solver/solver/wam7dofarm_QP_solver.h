...
#define wam7dofarm_QP_solver_SET_PRINTLEVEL    (2)
#endif
...
#define wam7dofarm_QP_solver_SET_MAXIT         (1000)	
...
typedef struct wam7dofarm_QP_solver_params
{
    ...
    /* vector of size 64 */
    wam7dofarm_QP_solver_FLOAT f8[64];

    /* vector of size 64 */
    wam7dofarm_QP_solver_FLOAT lb8[64];

    /* vector of size 36 */
    wam7dofarm_QP_solver_FLOAT ub8[36];

    /* matrix of size [15 x 64] (column major format) */
    wam7dofarm_QP_solver_FLOAT C8[960];

    /* vector of size 15 */
    wam7dofarm_QP_solver_FLOAT e8[15];

    /* vector of size 64 */
    wam7dofarm_QP_solver_FLOAT f9[64];

    /* vector of size 64 */
    wam7dofarm_QP_solver_FLOAT lb9[64];

    /* vector of size 36 */
    wam7dofarm_QP_solver_FLOAT ub9[36];

    /* matrix of size [15 x 64] (column major format) */
    wam7dofarm_QP_solver_FLOAT C9[960];

    /* vector of size 15 */
    wam7dofarm_QP_solver_FLOAT e9[15];

    /* vector of size 27 */
    wam7dofarm_QP_solver_FLOAT f10[27];

    /* vector of size 27 */
    wam7dofarm_QP_solver_FLOAT lb10[27];

    /* vector of size 15 */
    wam7dofarm_QP_solver_FLOAT ub10[15];

    /* matrix of size [12 x 27] (column major format) */
    wam7dofarm_QP_solver_FLOAT A10[324];

    /* vector of size 12 */
    wam7dofarm_QP_solver_FLOAT b10[12];
...
typedef struct wam7dofarm_QP_solver_output
{
    ...
    /* vector of size 36 */
    wam7dofarm_QP_solver_FLOAT z8[36];

    /* vector of size 36 */
    wam7dofarm_QP_solver_FLOAT z9[36];

    /* vector of size 15 */
    wam7dofarm_QP_solver_FLOAT z10[15];
